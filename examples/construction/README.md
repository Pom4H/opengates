...
for a period; site technical supervision (технадзор) has not accepted it. Until
they do, the contractor can't be paid for it and the next work package can't
close out.
...
| **Reviewer** | `technical_supervisor` — site supervision (технадзор) accepts responsibility. |
...
manifesto's pain — *"подрядчик заявил объём, технадзор не принял"* — made
